const translation = {
  ...
  actionMsg: {
    noModification: 'Không có thay đổi nào vào lúc này',
    modifiedSuccessfully: 'Đã sửa đổi thành công',
    modifiedUnsuccessfully: 'Sửa đổi không thành công',
    copySuccessfully: 'Đã sao chép thành công',
    copyLinkSuccessfully: 'Đã sao chép liên kết vào bộ nhớ tạm',
    paySucceeded: 'Thanh toán thành công',
    payCancelled: 'Đã hủy thanh toán',
    generatedSuccessfully: 'Đã tạo thành công',
  ...
  account: {
    ...
    email: 'Email',
    password: 'Mật khẩu',
    passwordTip: 'Bạn có thể đặt một mật khẩu cố định nếu bạn không muốn sử dụng mã đăng nhập tạm thởi',
  ...
  modelProvider: {
    ...
    loadBalancingInfo: 'Theo mặc định, cân bằng tải sử dụng chiến lược Vòng tròn. Nếu giới hạn tốc độ được kích hoạt, thởi gian hồi chiêu 1 phút sẽ được áp dụng.',
